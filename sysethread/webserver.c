//编译代码指令  gcc -std=gnu99 -g -o webserver webserver.c -phtread 
#include <stdio.h> 
#include <stdlib.h> 
#include <unistd.h> 
#include <errno.h> 
...
#define shm_key_sr 12340
#define shm_key_sw 12350
#define shm_key_wr 12360
#define shm_key_lw 12370

#define sem_key_sr 10340
#define sem_key_sw 10350
#define sem_key_wr 10360
#define sem_key_lw 10370
